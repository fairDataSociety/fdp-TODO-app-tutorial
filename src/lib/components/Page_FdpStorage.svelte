<script lang="ts">
    ...
    import Step_00_Setup from "./part1/Step-00-Setup.svelte";
    import Step_02_InitFDP from "./part1/Step-02-InitFDP.svelte";
    import Step_03_ListAccounts from "./part1/Step-03-ListAccounts.svelte";
    import Step_04_CreateWallet from "./part1/Step-04-Create-Wallet.svelte";
    import Step_07_ListPods from "./part1/Step-07-ListPods.svelte";
    import Step_06_CreateAppPod from "./part1/Step-06-CreateAppPod.svelte";
    import Step_08_CreateAppDir from "./part1/Step-08-CreateAppDir.svelte";
    import Step_09_CreateTododItem from "./part1/Step-09-CreateTododItem.svelte";
    import Step_10_ListTodos from "./part1/Step-10-ListTodos.svelte";
    import Step_11_DeleteTodo from "./part1/Step-11-DeleteTodo.svelte";
    import Step_12_ImportWallet from "./part1/Step-12-ImportWallet.svelte";
    import Step_13RegisterAccount from "./part1/Step-13-RegisterAccount.svelte";
  ...
  <h1><a id="fdpstorage">Using FdpStorage & Blossom</a></h1>
  <Step_00_Setup />
  <Step_02_InitFDP />
  {#if $next[1]}
  ...
  {#if $next[2.1]}
    ...
    {#if $next[10]}
      <section>
        <h2 id="f12">12. Next: Using FairOS</h2>
        <div class="notice">
          <p>
